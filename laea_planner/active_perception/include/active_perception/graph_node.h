...
public:
  ...
  static double computeCost_extend(const Vector3d& p1, const Vector3d& p2, const double& y1, const double& y2,
                            const Vector3d& v1, const double& yd1, const Vector3d& p_extend);
  static double computeCost_extend(const Vector3d& p1, const Vector3d& p2, const double& y1, const double& y2,
                             const Vector3d& v1, const Vector3d& p1_extend, const Vector3d& p2_extend);
